...
class SubscriptionConstants {
  ...
  static const String basicAiModel = 'claude-3-5-haiku-20241022'; // Basic 기본 모델 (1 크레딧)
  static const String premiumAiModel = 'claude-sonnet-4-20250514'; // Premium 기본 모델 (1 크레딧) / Basic 업그레이드 모델 (5 크레딧)
  static const String opusAiModel = 'claude-opus-4-20250514'; // Premium 사용자 전용 Opus 4 (5 크레딧)
  ...
  static const int basicGenerationLimit = 60; // Basic 월 출력 제한 횟수 - 60개로 설정
  static const int basicWordMinLimit = 5; // Basic 최소 단어 수 제한
  static const int basicWordMaxLimit = 15; // Basic 최대 단어 수 제한

  static const int premiumGenerationLimit = 100; // Premium 월 출력 제한 횟수 - 100개로 설정
  static const int premiumWordMinLimit = 5; // Premium 최소 단어 수 제한
  static const int premiumWordMaxLimit = 20; // Premium 최대 단어 수 제한
  
  // 모델별 크레딧 비용
  static const int defaultCreditCost = 1; // 기본 모델 크레딧 비용
  static const int opusCreditCost = 5; // Opus 모델 크레딧 비용
  
  // 가격 표시용 (실제 과금은 스토어를 통해)
  static const String basicMonthlyPrice = '₩4,990';
  static const String basicMonthlyDiscountPrice = '₩2,990'; // 출시 3달간 할인!
  static const String premiumMonthlyPrice = '₩9,900';
  static const String premiumMonthlyDiscountPrice = '₩5,990'; // 출시 3달간 할인!
