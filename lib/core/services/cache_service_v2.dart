...
import 'package:chunk_up/core/services/base/disposable_service.dart';

/// Enhanced cache service with memory limits and lifecycle management
class CacheServiceV2 extends DisposableService {
  ...
  CacheServiceV2({StorageService? storageService}) 
