...
class RouteService {
  ...
  static Map<String, Widget Function(BuildContext)> getAppRoutes({required bool hasApiKey}) {
    return {
      RouteNames.home: (context) => MainScreen(key: MainScreen.globalKey),
      ...
      RouteNames.characterManagement: (context) => const CharacterManagementScreen(),
      ...
      RouteNames.apiKeySetup: (context) => const ApiKeySetupScreen(isInitialSetup: true),
