...
2. 사용자의 권리 및 의무
   ...
   d. 사용자는 자신의 데이터를 백업하는 것에 대한 책임이 있습니다.''',
        ...
        _buildSection(
          '제10조 (서비스 이용 제한)',
          '''1. 회사는 사용자가 다음 각 호에 해당하는 경우 사전 통지 없이 서비스 이용을 제한할 수 있습니다:
   a. 타인의 앱 이용을 방해하거나 정보를 도용하는 등 전자거래질서를 위협하는 경우
   b. 앱을 이용하여 법령 또는 본 약관에서 금지하는 행위를 하는 경우
   c. 앱 운영을 고의로 방해하는 경우
   d. 기타 관련 법령에 위배되거나 회사의 업무를 방해하는 경우

2. 회사는 전항에도 불구하고, 주민등록법을 위반한 명의도용 및 결제도용, 저작권법을 위반한 불법프로그램의 제공 및 운영방해, 정보통신망법을 위반한 불법통신 및 해킹, 악성프로그램의 배포, 접속권한 초과행위 등과 같이 관련법을 위반한 경우에는 즉시 영구이용정지를 할 수 있습니다.''',
        ),
        _buildSection(
          '제11조 (손해배상)',
          '''1. 회사와 사용자는 서비스 이용과 관련하여 고의 또는 과실로 상대방에게 손해를 입힌 경우 이를 배상할 책임이 있습니다.

2. 회사는 무료로 제공하는 서비스 이용과 관련하여 사용자에게 발생한 손해에 대해서는 고의 또는 중대한 과실이 없는 한 책임을 지지 않습니다.

3. 회사는 앱에서 무료로 제공하는 서비스의 이용과 관련하여 사용자에게 발생한 손해 중 사용자의 고의, 과실에 의한 손해에 대하여는 배상하지 않습니다.''',
        ),
        _buildSection(
          '제12조 (면책사항)',
          '''1. 회사는 천재지변, 전쟁, 기간통신사업자의 서비스 중지 등 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.

2. 회사는 사용자의 귀책사유로 인한 서비스 이용의 장애에 대하여 책임을 지지 않습니다.

3. 회사는 사용자가 서비스를 이용하여 기대하는 학습 효과, 이익 등을 얻지 못하거나 상실한 것에 대하여 책임을 지지 않습니다.

4. 회사는 사용자가 앱에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등 내용에 관하여 책임을 지지 않습니다.''',
        ),
        _buildSection(
          '제13조 (분쟁해결 및 관할법원)',
          '''1. 회사와 사용자 간 발생한 분쟁은 상호 협의하여 해결하는 것을 원칙으로 합니다.

2. 제1항의 협의에서도 분쟁이 해결되지 않을 경우 회사와 사용자는 민사소송법상의 관할법원에 소를 제기할 수 있습니다.

3. 회사와 사용자 간에 제기된 소송에는 대한민국 법을 적용합니다.''',
        ),
        _buildSection(
          '제14조 (기타)',
          '''1. 본 약관에 명시되지 않은 사항은 관련 법령 및 회사가 정한 서비스의 세부이용지침 등의 규정에 따릅니다.

2. 회사는 필요한 경우 서비스 내의 개별 서비스에 대한 세부이용지침을 정할 수 있으며, 해당 내용은
앱 내에 게시합니다.''',
        ),
